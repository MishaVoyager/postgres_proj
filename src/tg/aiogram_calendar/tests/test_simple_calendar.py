...
from tg.aiogram_calendar.schemas import SimpleCalendarCallback
...
async def test_start_calendar_locale():
    cal = SimpleCalendar(show_alerts=True, locale='ru_RU.UTF-8', tz=tz.utc, cancel_btn="Отмена", today_btn="Этот месяц")
    result = await cal.start_calendar()
